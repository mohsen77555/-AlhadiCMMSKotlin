...
drop policy if exists "asset_bom_headers auth all" on public.asset_bom_headers;
...
drop policy if exists "asset_bom_items auth all" on public.asset_bom_items;
...
drop policy if exists "asset_characteristics auth all" on public.asset_characteristics;
...
drop policy if exists "asset_documents auth all" on public.asset_documents;
...
drop policy if exists "assets auth all" on public.assets;
...
drop policy if exists "asset_installations auth all" on public.asset_installations;
...
drop policy if exists "asset_movements auth all" on public.asset_movements;
...
drop policy if exists "asset_status_history auth all" on public.asset_status_history;
...
drop policy if exists "audit_log auth all" on public.audit_log;
...
drop policy if exists "capa_actions auth all" on public.capa_actions;
...
drop policy if exists "functional_locations auth all" on public.functional_locations;
...
drop policy if exists "inventory_transactions auth all" on public.inventory_transactions;
...
drop policy if exists "maintenance_notifications auth all" on public.maintenance_notifications;
...
drop policy if exists "measurement_readings auth all" on public.measurement_readings;
...
drop policy if exists "measuring_points auth all" on public.measuring_points;
...
drop policy if exists "org_units auth all" on public.org_units;
...
drop policy if exists "pm_checklist_items auth all" on public.pm_checklist_items;
...
drop policy if exists "preventive_maintenance auth all" on public.preventive_maintenance;
...
drop policy if exists "purchase_orders auth all" on public.purchase_orders;
...
drop policy if exists "purchase_order_lines auth all" on public.purchase_order_lines;
...
drop policy if exists "serial_numbers auth all" on public.serial_numbers;
...
drop policy if exists "serial_number_movements auth all" on public.serial_number_movements;
...
drop policy if exists "serial_number_profiles auth all" on public.serial_number_profiles;
...
drop policy if exists "spare_parts auth all" on public.spare_parts;
...
drop policy if exists "task_lists auth all" on public.task_lists;
...
drop policy if exists "task_list_operations auth all" on public.task_list_operations;
...
drop policy if exists "users auth all" on public.users;
create policy "users auth all" on public.users for all to authenticated using (true) with check (true);
alter table public.warehouses enable row level security;
drop policy if exists "warehouses auth all" on public.warehouses;
...
drop policy if exists "work_order_confirmations auth all" on public.work_order_confirmations;
...
drop policy if exists "work_orders auth all" on public.work_orders;
...
drop policy if exists "work_order_history auth all" on public.work_order_history;
...
drop policy if exists "work_order_materials auth all" on public.work_order_materials;
...
drop policy if exists "work_order_operations auth all" on public.work_order_operations;
...
drop policy if exists "work_order_photos auth all" on public.work_order_photos;
...
drop policy if exists "work_permits auth all" on public.work_permits;
